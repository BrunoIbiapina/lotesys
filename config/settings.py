...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            # USE APENAS UM 'builtins'
            "builtins": [
                # tags auxiliares da app vendas (ok manter)
                "vendas.templatetags.compat",
                # carrega APENAS a lib do mural com o nome mural_ui
                "mural.templatetags.mural_ui",
            ],
            "context_processors": [
